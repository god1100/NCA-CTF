...
<body class="admin-body">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="admin-sidebar-nav">
            ...
            <a href="/NCA-CTF/public/admin/index.php" class="<?php echo $currentPage === 'dashboard' ? 'active' : ''; ?>">
                <span class="nav-icon">📊</span> Dashboard
            </a>
            <a href="/NCA-CTF/public/admin/challenges.php" class="<?php echo $currentPage === 'challenges' ? 'active' : ''; ?>">
                <span class="nav-icon">🏆</span> Challenges
            </a>
            <div class="nav-divider"></div>
            <a href="#" id="adminLogoutBtn" class="nav-logout">
    ...
    <main class="admin-main">
        <header class="admin-header">
            <div class="admin-header-title">
                <h1>Dashboard</h1>
                <p class="subtitle">NCA CTF Administration</p>
            </div>
